...
const navigation = [
  { name: "פגישות", nameKey: "nav.meetings", href: "/meetings", icon: Calendar },
  { name: "זיכרון", nameKey: "nav.memory", href: "/memory", icon: Search },
  { name: "ישויות", nameKey: "nav.entities", href: "/entities", icon: Users },
];
