...
export function PrivacyPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-gradient-to-br from-slate-50 via-white to-teal-50/30 py-8" dir={isRTL ? "rtl" : "ltr"}>
      <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4">
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  ...
                  {index < arr.length - 1 && (
                    <div className={`hidden md:block w-8 h-0.5 bg-teal-200 ${isRTL ? "rotate-180" : ""}`} />
                  )}
                </div>
              ))}
            </div>
        ...
        <div className="mt-10 text-center text-sm text-muted-foreground">
          <p>
            {isRTL
              ? "יש שאלות על אבטחה ופרטיות? צור קשר:"
              : "Questions about security and privacy? Contact us:"}
          </p>
          <a href="mailto:security@tami.ai" className="text-teal-600 hover:underline">
            security@tami.ai
          </a>
        </div>
      </div>
